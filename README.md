...
https://loan-status-prediction.streamlit.app/

In this project, I developed a web app using Streamlit Cloud to accurately predict Loan Status. I analysed various Machine Learning algorithms to predict loan status of a new applicant using various background informations about the applicant and deployed the best one.Parameters like credit score, loan amount, lifestyle, career, income and assets are the deciding factors in getting the loan approval.
